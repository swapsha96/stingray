...
class TestBispectrum(object):
    ...
    def setup_class(cls):
        ...
        cls.lc1 = Lightcurve(
            [0.5, 1.0, 1.5, 2.0, 2.5, 3.0], [2, 1, 3, 1, 4, 2])
    ...
    def test_bispectrum_with_none_maxlag(self):
        ...
        bispec_mag = np.array([[2.33661732,
                                2.54301333,
                                0.62221312,
                                1.84034823,
                                0.37973002],
    ...
    def test_bispectrum_unbiased_scale(self):
        ...
        bispec_mag = np.array([[2.75858211,
                                3.40375249,
                                1.01973097,
                                2.83562286,
                                0.49792363],
    ...
    def test_bispectrum_window_parzen(self):
        ...
        bispec = np.array([[0.32973576 -
                            7.99387943e-02j, 0.30089706 -
                            1.04641240e-01j, 0.27257082 -
                            3.99693972e-02j, 0.28390294 +
                            2.47024460e-02j, 0.31923282 +
                            6.93889390e-18j], [0.30089706 -
                                               1.04641240e-01j, 0.29306424 -
                                               1.29343686e-01j, 0.27122918 -
                                               6.46718431e-02j, 0.26556718 +
                                               0.00000000e+00j, 0.28390294 -
                                               2.47024460e-02j], [0.27257082 -
                                                                  3.99693972e-02j, 0.27122918 -
                                                                  6.46718431e-02j, 0.27040000 +
                                                                  0.00000000e+00j, 0.27122918 +
                                                                  6.46718431e-02j, 0.27257082 +
                                                                  3.99693972e-02j], [0.28390294 +
                                                                                     2.47024460e-02j, 0.26556718 +
                                                                                     0.00000000e+00j, 0.27122918 +
                                                                                     6.46718431e-02j, 0.29306424 +
                                                                                     1.29343686e-01j, 0.30089706 +
                                                                                     1.04641240e-01j], [0.31923282 -
                                                                                                        6.93889390e-18j, 0.28390294 -
                                                                                                        2.47024460e-02j, 0.27257082 +
                                                                                                        3.99693972e-02j, 0.30089706 +
                                                                                                        1.04641240e-01j, 0.32973576 +
                                                                                                        7.99387943e-02j]])
    ...
    def test_bispectrum_window_hamming(self):
        ...
        bispec = np.array([[0.49072469 -
                            3.67258307e-01j, 0.34762420 -
                            4.91066236e-01j, 0.21848648 -
                            1.93948024e-01j, 0.26176961 +
                            1.19866471e-01j, 0.43090809 +
                            5.55111512e-17j], [0.34762420 -
                                               4.91066236e-01j, 0.30777863 -
                                               5.94236424e-01j, 0.21286804 -
                                               3.03495625e-01j, 0.19173603 +
                                               5.55111512e-17j, 0.26176961 -
                                               1.19866471e-01j], [0.21848648 -
                                                                  1.93948024e-01j, 0.21286804 -
                                                                  3.03495625e-01j, 0.19471176 +
                                                                  0.00000000e+00j, 0.21286804 +
                                                                  3.03495625e-01j, 0.21848648 +
                                                                  1.93948024e-01j], [0.26176961 +
                                                                                     1.19866471e-01j, 0.19173603 -
                                                                                     5.55111512e-17j, 0.21286804 +
                                                                                     3.03495625e-01j, 0.30777863 +
                                                                                     5.94236424e-01j, 0.34762420 +
                                                                                     4.91066236e-01j], [0.43090809 -
                                                                                                        5.55111512e-17j, 0.26176961 -
                                                                                                        1.19866471e-01j, 0.21848648 +
                                                                                                        1.93948024e-01j, 0.34762420 +
                                                                                                        4.91066236e-01j, 0.49072469 +
                                                                                                        3.67258307e-01j]])
    ...
    def test_bispectrum_window_hanning(self):
        ...
        bispec = np.array([[0.45494303 -
                            3.19755177e-01j, 0.33958823 -
                            4.18564961e-01j, 0.22628328 -
                            1.59877589e-01j, 0.27161177 +
                            9.88097838e-02j, 0.41293126 +
                            5.55111512e-17j], [0.33958823 -
                                               4.18564961e-01j, 0.30825697 -
                                               5.17374745e-01j, 0.22091672 -
                                               2.58687372e-01j, 0.19826874 +
                                               5.55111512e-17j, 0.27161177 -
                                               9.88097838e-02j], [0.22628328 -
                                                                  1.59877589e-01j, 0.22091672 -
                                                                  2.58687372e-01j, 0.21760000 +
                                                                  0.00000000e+00j, 0.22091672 +
                                                                  2.58687372e-01j, 0.22628328 +
                                                                  1.59877589e-01j], [0.27161177 +
                                                                                     9.88097838e-02j, 0.19826874 -
                                                                                     5.55111512e-17j, 0.22091672 +
                                                                                     2.58687372e-01j, 0.30825697 +
                                                                                     5.17374745e-01j, 0.33958823 +
                                                                                     4.18564961e-01j], [0.41293126 -
                                                                                                        5.55111512e-17j, 0.27161177 -
                                                                                                        9.88097838e-02j, 0.22628328 +
                                                                                                        1.59877589e-01j, 0.33958823 +
                                                                                                        4.18564961e-01j, 0.45494303 +
                                                                                                        3.19755177e-01j]])
    ...
    def test_bispectrum_window_triangular(self):
        ...
        bispec = np.array([[0.82428321 -
                            7.24678086e-01j, 0.42949926 -
                            1.11847388e+00j, 0.16365995 -
                            5.32196997e-01j, 0.12187354 +
                            3.28915833e-01j, 0.57999943 +
                            5.55111512e-17j], [0.42949926 -
                                               1.11847388e+00j, 0.25368159 -
                                               1.17255377e+00j, 0.18598485 -
                                               6.91254876e-01j, 0.18948537 +
                                               1.11022302e-16j, 0.12187354 -
                                               3.28915833e-01j], [0.16365995 -
                                                                  5.32196997e-01j, 0.18598485 -
                                                                  6.91254876e-01j, -
                                                                  0.09896960 +
                                                                  0.00000000e+00j, 0.18598485 +
                                                                  6.91254876e-01j, 0.16365995 +
                                                                  5.32196997e-01j], [0.12187354 +
                                                                                     3.28915833e-01j, 0.18948537 -
                                                                                     1.11022302e-16j, 0.18598485 +
                                                                                     6.91254876e-01j, 0.25368159 +
                                                                                     1.17255377e+00j, 0.42949926 +
                                                                                     1.11847388e+00j], [0.57999943 -
                                                                                                        5.55111512e-17j, 0.12187354 -
                                                                                                        3.28915833e-01j, 0.16365995 +
                                                                                                        5.32196997e-01j, 0.42949926 +
                                                                                                        1.11847388e+00j, 0.82428321 +
                                                                                                        7.24678086e-01j]])
    ...
    def test_bispectrum_window_welch(self):
        ...
        bispec = np.array([[0.66362182 -
                            7.19449149e-01j, 0.40407352 -
                            9.41771162e-01j, 0.14913738 -
                            3.59724574e-01j, 0.25112648 +
                            2.22322014e-01j, 0.56909534 +
                            5.55111512e-17j], [0.40407352 -
                                               9.41771162e-01j, 0.33357818 -
                                               1.16409318e+00j, 0.13706262 -
                                               5.82046588e-01j, 0.08610466 +
                                               0.00000000e+00j, 0.25112648 -
                                               2.22322014e-01j], [0.14913738 -
                                                                  3.59724574e-01j, 0.13706262 -
                                                                  5.82046588e-01j, 0.12960000 +
                                                                  0.00000000e+00j, 0.13706262 +
                                                                  5.82046588e-01j, 0.14913738 +
                                                                  3.59724574e-01j], [0.25112648 +
                                                                                     2.22322014e-01j, 0.08610466 +
                                                                                     0.00000000e+00j, 0.13706262 +
                                                                                     5.82046588e-01j, 0.33357818 +
                                                                                     1.16409318e+00j, 0.40407352 +
                                                                                     9.41771162e-01j], [0.56909534 -
                                                                                                        5.55111512e-17j, 0.25112648 -
                                                                                                        2.22322014e-01j, 0.14913738 +
                                                                                                        3.59724574e-01j, 0.40407352 +
                                                                                                        9.41771162e-01j, 0.66362182 +
                                                                                                        7.19449149e-01j]])
    ...
    def test_bispectrum_window_blackmann(self):
        ...
        bispec = np.array([[0.36998520 -
                            1.56242334e-01j, 0.31320687 -
                            2.04896068e-01j, 0.25789699 -
                            7.84933643e-02j, 0.27972923 +
                            4.85115670e-02j, 0.34901011 +
                            2.77555756e-17j], [0.31320687 -
                                               2.04896068e-01j, 0.29778797 -
                                               2.52805407e-01j, 0.25527601 -
                                               1.26632734e-01j, 0.24440392 +
                                               2.77555756e-17j, 0.27972923 -
                                               4.85115670e-02j], [0.25789699 -
                                                                  7.84933643e-02j, 0.25527601 -
                                                                  1.26632734e-01j, 0.25316762 +
                                                                  0.00000000e+00j, 0.25527601 +
                                                                  1.26632734e-01j, 0.25789699 +
                                                                  7.84933643e-02j], [0.27972923 +
                                                                                     4.85115670e-02j, 0.24440392 -
                                                                                     2.77555756e-17j, 0.25527601 +
                                                                                     1.26632734e-01j, 0.29778797 +
                                                                                     2.52805407e-01j, 0.31320687 +
                                                                                     2.04896068e-01j], [0.34901011 -
                                                                                                        2.77555756e-17j, 0.27972923 -
                                                                                                        4.85115670e-02j, 0.25789699 +
                                                                                                        7.84933643e-02j, 0.31320687 +
                                                                                                        2.04896068e-01j, 0.36998520 +
                                                                                                        1.56242334e-01j]])

        window = np.array([[0.00000000e+00,
                            0.00000000e+00,
                            0.00000000e+00,
                            8.41430799e-04,
                            4.73205937e-05],
    ...
    def test_bispectrum_window_flattop(self):
        ...
        bispec = np.array([[28.90860041 -
                            0.40702734j, 28.76176133 -
                            0.53280571j, 28.61753157 -
                            0.20351367j, 28.67523175 +
                            0.12577837j, 28.85512219 +
                            0.j, ], [28.76176133 -
                                     0.53280571j, 28.72187869 -
                                     0.65858408j, 28.61070029 -
                                     0.32929204j, 28.58187089 +
                                     0.j, 28.67523175 -
                                     0.12577837j], [28.61753157 -
                                                    0.20351367j, 28.61070029 -
                                                    0.32929204j, 28.60647832 +
                                                    0.j, 28.61070029 +
                                                    0.32929204j, 28.61753157 +
                                                    0.20351367j], [28.67523175 +
                                                                   0.12577837j, 28.58187089 +
                                                                   0.j, 28.61070029 +
                                                                   0.32929204j, 28.72187869 +
                                                                   0.65858408j, 28.76176133 +
                                                                   0.53280571j], [28.85512219 +
                                                                                  0.j, 28.67523175 -
                                                                                  0.12577837j, 28.61753157 +
                                                                                  0.20351367j, 28.76176133 +
                                                                                  0.53280571j, 28.90860041 +
                                                                                  0.40702734j]])
